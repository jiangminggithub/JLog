 ...
 * calling.
 * <br>Also, JLog is very flexible, almost every component is replaceable.
 * <p>
 ...
 * <br>Using one of
 * <br>{@link JLog#init()}
 * <br>{@link JLog#init(int)},
 * <br>{@link JLog#init(LogConfiguration)}
 * <br>{@link JLog#init(Printer...)},
 * <br>{@link JLog#init(int, Printer...)},
 * <br>{@link JLog#init(LogConfiguration, Printer...)},
...
public class JLog {
    ...
    /**
     * Global logger for all direct logging via {@link JLog}.
     */
    ...
    public static void init(LogConfiguration logConfiguration, Printer... printers) {
        if (sIsInitialized) {
            Platform.get().warn("JLog is already initialized, do not initialize again");
        }
        sIsInitialized = true;
     ...
     *                         it can be a package name like "com.elvishew.JLog", a class name
     ...
     * @since 1.0.0
     */
    public static void v(String prefix, Object object) {
        assertInitialization();
        sLogger.v(prefix, object);
    }
     ...
     * @param tr     the throwable to be log
     */
    public static void v(String prefix, String msg, Throwable tr) {
        assertInitialization();
        sLogger.v(prefix, msg, tr);
    }
     ...
     * @param tr     the throwable to be log
     */
    public static void d(String prefix, String msg, Throwable tr) {
        assertInitialization();
        sLogger.d(prefix, msg, tr);
    }
     ...
     * @param tr     the throwable to be log
     */
    public static void i(String prefix, String msg, Throwable tr) {
        assertInitialization();
        sLogger.i(prefix, msg, tr);
    }
     ...
     * @since 1.0.0
     */
    public static void w(String prefix, Object object) {
        assertInitialization();
        sLogger.w(prefix, object);
    }
     ...
     * @since 1.0.0
     */
    public static void e(String prefix, Object object) {
        assertInitialization();
        sLogger.e(prefix, object);
    }
     ...
     * @since 1.0.0
     */
    public static void log(int logLevel, String prefix, Object object) {
        assertInitialization();
        sLogger.log(logLevel, prefix, object);
    }
     ...
     * @since 1.0.0
     */
    public static void log(int logLevel, String prefix, String msg) {
        assertInitialization();
        sLogger.log(logLevel, prefix, msg);
    }
     ...
     * @since 1.0.0
     */
    public static void log(int logLevel, String prefix, String msg, Throwable tr) {
        assertInitialization();
        sLogger.log(logLevel, prefix, msg, tr);
    }
