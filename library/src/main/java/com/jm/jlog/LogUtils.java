...
import static com.jm.jlog.JLog.assertInitialization;
...
public class LogUtils {
  ...
  public static String formatJson(String json) {
    ...
    return JLog.sLogConfiguration.jsonFormatter.format(json);
  }
  ...
  public static String formatXml(String xml) {
    assertInitialization();
    return JLog.sLogConfiguration.xmlFormatter.format(xml);
  }
  ...
  public static String formatThrowable(Throwable throwable) {
    assertInitialization();
    return JLog.sLogConfiguration.throwableFormatter.format(throwable);
  }
  ...
  public static String formatThread(Thread thread) {
    assertInitialization();
    return JLog.sLogConfiguration.threadFormatter.format(thread);
  }
  ...
  public static String formatStackTrace(StackTraceElement[] stackTrace) {
    assertInitialization();
    return JLog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
  }
  ...
  public static String addBorder(String[] segments) {
    assertInitialization();
    return JLog.sLogConfiguration.borderFormatter.format(segments);
  }
