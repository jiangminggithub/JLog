 ...
 * <p>
 * A {@link Logger} is always generated and mostly accessed by {@link JLog}, but for customization
 * purpose, you can configure a {@link Logger} via the {@link Builder} which is returned by
 * {@link JLog} when you trying to start a customization using {@link JLog#tag(String)}
 ...
 * the {@link Logger} assuming that you are using the {@link JLog} directly.
 */
public class Logger {
     ...
     * Log an object with level {@link LogLevel#VERBOSE}.
     *
     * @param prefix the prefix string to the printing log
     * @param object the object to log
     * @see Builder#addObjectFormatter(Class, ObjectFormatter)
     * @since 1.0.0
     */
    public void v(String prefix, Object object) {
        println(LogLevel.VERBOSE, formatPrefix(prefix), object);
    }
    ...
    public void v(String prefix, String msg) {
        println(LogLevel.VERBOSE, formatPrefix(prefix) + msg);
    }
    ...
    public void v(String prefix, String msg, Throwable tr) {
        println(LogLevel.VERBOSE, formatPrefix(prefix) + msg, tr);
    }
    ...
    public void d(String prefix, Object object) {
        println(LogLevel.DEBUG, formatPrefix(prefix), object);
    }
    ...
    public void d(String prefix, String msg) {
        println(LogLevel.DEBUG, formatPrefix(prefix) + msg);
    }
    ...
    public void d(String prefix, String msg, Throwable tr) {
        println(LogLevel.DEBUG, formatPrefix(prefix) + msg, tr);
    }
     ...
     * @since 1.0.0
     */
    public void i(String prefix, Object object) {
        println(LogLevel.INFO, formatPrefix(prefix), object);
    }
    ...
    public void i(String prefix, String msg) {
        println(LogLevel.INFO, formatPrefix(prefix) + msg);
    }
    ...
    public void i(String prefix, String msg, Throwable tr) {
        println(LogLevel.INFO, formatPrefix(prefix) + msg, tr);
    }
     ...
     * @since 1.0.0
     */
    public void w(String prefix, Object object) {
        println(LogLevel.WARN, formatPrefix(prefix), object);
    }
    ...
    public void w(String prefix, String msg) {
        println(LogLevel.WARN, formatPrefix(prefix) + msg);
    }
    ...
    public void w(String prefix, String msg, Throwable tr) {
        println(LogLevel.WARN, formatPrefix(prefix) + msg, tr);
    }
     ...
     * @since 1.0.0
     */
    public void e(String prefix, Object object) {
        println(LogLevel.ERROR, formatPrefix(prefix), object);
    }
    ...
    public void e(String prefix, String msg) {
        println(LogLevel.ERROR, formatPrefix(prefix) + msg);
    }
    ...
    public void e(String prefix, String msg, Throwable tr) {
        println(LogLevel.ERROR, formatPrefix(prefix) + msg, tr);
    }
     ...
     * @since 1.0.0
     */
    public void log(int logLevel, String prefix, Object object) {
        println(logLevel, prefix, object);
    }
     ...
     * @since 1.0.0
     */
    public void log(int logLevel, String prefix, String msg) {
     ...
     * @since 1.0.0
     */
    public void log(int logLevel, String prefix, String msg, Throwable tr) {
        println(logLevel, prefix, msg, tr);
    }
    ...
    public void json(String json) {
        int logLevel = logConfiguration.logLevel;
        if (logLevel == LogLevel.ALL) {
            logLevel = LogLevel.INFO;
        }
        printlnInternal(logLevel, logConfiguration.jsonFormatter.format(json));
    }
     ...
     * @param json   the JSON string to log
     */
    public void json(String prefix, String json) {
        int logLevel = logConfiguration.logLevel;
        if (logLevel == LogLevel.ALL) {
            logLevel = LogLevel.INFO;
        }
        printlnInternal(logLevel, formatPrefix(prefix)
    ...
    public void xml(String xml) {
        ...
        printlnInternal(logLevel, logConfiguration.xmlFormatter.format(xml));
    }
     ...
     * @param xml    the XML string to log
     */
    public void xml(String prefix, String xml) {
        int logLevel = logConfiguration.logLevel;
        if (logLevel == LogLevel.ALL) {
            logLevel = LogLevel.INFO;
        }
    ...
    /**
     * Print an object in a new line with prefix string.
     *
     * @param logLevel the log level of the printing object
     * @param prefix   the log level of the prefix string.
     * @param object   the object to print
     */
    private <T> void println(int logLevel, String prefix, T object) {
        if (logLevel < logConfiguration.logLevel) {
            return;
        }
        String objectString;
        ...
        printlnInternal(logLevel, prefix + objectString);
    }
    ...
    /**
     * Format a new string with prefix string.
     *
     * @param prefix prefix the prefix string to the printing log
     * @return the formatted prefix string to [prefix]
     */
    ...
    public static class Builder {
         ...
         * it can be a package name like "com.elvishew.JLog", a class name like "com.yourdomain.logWrapper",
         ...
         *                         "com.elvishew.JLog", a class name like "com.yourdomain.logWrapper",
         *                         or something else between package name and class name, like "com.yourdomain.".
         *                         It is mostly used when you are using a logger wrapper
         * @param depth            the number of stack trace elements we should log, 0 if no limitation
         * @return the builder
         ...
         */
        public void log(int logLevel, String prefix, Object object) {
            build().log(logLevel, prefix, object);
        }
        ...
        /**
         * Convenience of {@link #build()} and {@link Logger#log(int, String, String)}.
         *
         * @since 1.0.0
         */
        public void log(int logLevel, String prefix, String msg) {
            build().log(logLevel, prefix, msg);
        }
        ...
        /**
         * Convenience of {@link #build()} and {@link Logger#log(int, String, String, Throwable)}.
         *
         * @since 1.0.0
         */
        public void log(int logLevel, String prefix, String msg, Throwable tr) {
            build().log(logLevel, prefix, msg, tr);
        }
        ...
        /**
         * Convenience of {@link #build()} and {@link Logger#json(String, String)}.
         */
        public void json(String prefix, String json) {
            build().json(prefix, json);
        }
