 ...
 * so if we setup a log level using <code>JLog.init(...)</code>, all the logs which is with
...
public class LogLevel {
  ...
  /**
   * Log level for JLog.v.
   */
  public static final int VERBOSE = 2;

  /**
   * Log level for JLog.d.
   */
  public static final int DEBUG = 3;

  /**
   * Log level for JLog.i.
   */
  public static final int INFO = 4;

  /**
   * Log level for JLog.w.
   */
  public static final int WARN = 5;

  /**
   * Log level for JLog.e.
   */
  public static final int ERROR = 6;

  /**
   * Log level for JLog#init, printing all logs.
   */
  public static final int ALL = Integer.MIN_VALUE;

  /**
   * Log level for JLog#init, printing no log.
   */
